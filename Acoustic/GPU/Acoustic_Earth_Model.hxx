...
public:
	Acoustic_Earth_Model(
		...
		int med_Axis,
		int slow_Axis,
		int dimx,				// net dimensions of propagation volume
		int dimy,				// determines sponge dimensions etc.
		int dimz,
		int x0,
		int x1,
		int y0,
	...
	Index_Calculator* Get_Index_Calculator() {return _icalc;}
...
private:
	...
	void _Create_Compressed_Earth_Model_No_Q(int OTflag, float gamfac, float dtout);
	void Find_Min_Max_Q(
		const char* name,
		const char* filename,
		float const_val,
