...
if (fsafe /= fmax_40db) then  ! don't reset fmax if it is the limiting freq
  ...
  if (ave_amp_ratio > 1.e-3) then  ! 1.e-3 is equiv to -60dB
    write(*,*) '.....power above fsafe exceeds -60dB limit!'
    write(*,*) '.....resetting fmax to fsafe!'
    fmax = fsafe*0.25  ! 0.1 converts fmax from -60dB to -3dB 
    write(*,*) '......fmax = ', fsafe
  else
    write(*,*) '.....power above fsafe is below -60dB limit'
    write(*,*) '.....fmax is ok; leave unchanged'
  endif
endif
