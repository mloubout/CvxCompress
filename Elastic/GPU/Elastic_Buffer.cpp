	...
	if (_Is_Compute)
	{
		...
		else if (_Is_PV)
		{
			...
			Host_Propagate_Particle_Velocities_Kernel(
				...
				job->Get_NABC_TOP(),
				job->Get_NABC_BOT(),
				job->Get_Earth_Model_Attribute_Min(job->Attr_Idx_Q),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Q),
				job->Get_FQ(),
				job->Get_Earth_Model_Attribute_Min(job->Attr_Idx_Density),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Density),
				one_y_size,
		...
		else
		{
			...
			Host_Propagate_Stresses_Orthorhombic_Kernel(
				...
				job->Get_NABC_TOP(),
				job->Get_NABC_BOT(),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Vp),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Vp),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Vs),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Vs),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Density),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Density),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Dip),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Dip),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Azimuth),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Azimuth),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Rake),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Rake),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Delta1),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Delta1),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Delta2),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Delta2),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Delta3),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Delta3),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Epsilon1),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Epsilon1),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Epsilon2),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Epsilon2),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Gamma1),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Gamma1),
				job->Get_Earth_Model_Attribute_Min  (job->Attr_Idx_Gamma2),
				job->Get_Earth_Model_Attribute_Range(job->Attr_Idx_Gamma2),
				one_y_size,
				shot->Inject_Source(cmp_block_timestep),
