        ...
        )
{
	...
	int tid = blockIdx.x * blockDim.y * blockDim.x + threadIdx.y * blockDim.x + threadIdx.x; 
		...
		int recflags=0, tid0=0, outidx=0, offloc=1+2*num_files, offres=0;
        ...
        )
{
	...
	int tid = blockIdx.x * blockDim.y * blockDim.x + threadIdx.y * blockDim.x + threadIdx.x;
		...
		bool found_it = false;
		float recx, recy, recz;
		int tid0=0, outidx=0, offloc=1+2*num_files, offres=0;
		for (int iFile = 0;  iFile < num_files;  ++iFile)
		{	
			int nn = iloc[1+2*iFile];
	...
	)
{
	if (blockIdx.y == 0)
	{
		if (is_vp_0)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_0,x0_0,y0_0,nx_0,ny_0,nz_0,rcv_binned_0,num_rx_0,res_0);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_0,x0_0,y0_0,nx_0,ny_0,nz_0,rcv_binned_0,num_rx_0,res_0);
		}
	}
	else if (blockIdx.y == 1)
	{
		if (is_vp_1)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_1,x0_1,y0_1,nx_1,ny_1,nz_1,rcv_binned_1,num_rx_1,res_1);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_1,x0_1,y0_1,nx_1,ny_1,nz_1,rcv_binned_1,num_rx_1,res_1);
		}
	}
	else if (blockIdx.y == 2)
	{
		if (is_vp_2)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_2,x0_2,y0_2,nx_2,ny_2,nz_2,rcv_binned_2,num_rx_2,res_2);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_2,x0_2,y0_2,nx_2,ny_2,nz_2,rcv_binned_2,num_rx_2,res_2);
		}
	}
	else if (blockIdx.y == 3)
	{
		if (is_vp_3)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_3,x0_3,y0_3,nx_3,ny_3,nz_3,rcv_binned_3,num_rx_3,res_3);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_3,x0_3,y0_3,nx_3,ny_3,nz_3,rcv_binned_3,num_rx_3,res_3);
		}
	}
	else if (blockIdx.y == 4)
	{
		if (is_vp_4)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_4,x0_4,y0_4,nx_4,ny_4,nz_4,rcv_binned_4,num_rx_4,res_4);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_4,x0_4,y0_4,nx_4,ny_4,nz_4,rcv_binned_4,num_rx_4,res_4);
		}
	}
	else if (blockIdx.y == 5)
	{
		if (is_vp_5)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_5,x0_5,y0_5,nx_5,ny_5,nz_5,rcv_binned_5,num_rx_5,res_5);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_5,x0_5,y0_5,nx_5,ny_5,nz_5,rcv_binned_5,num_rx_5,res_5);
		}
	}
	else if (blockIdx.y == 6)
	{
		if (is_vp_6)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_6,x0_6,y0_6,nx_6,ny_6,nz_6,rcv_binned_6,num_rx_6,res_6);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_6,x0_6,y0_6,nx_6,ny_6,nz_6,rcv_binned_6,num_rx_6,res_6);
		}
	}
	else if (blockIdx.y == 7)
	{
		if (is_vp_7)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_7,x0_7,y0_7,nx_7,ny_7,nz_7,rcv_binned_7,num_rx_7,res_7);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_7,x0_7,y0_7,nx_7,ny_7,nz_7,rcv_binned_7,num_rx_7,res_7);
		}
	}
	else if (blockIdx.y == 8)
	{
		if (is_vp_8)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_8,x0_8,y0_8,nx_8,ny_8,nz_8,rcv_binned_8,num_rx_8,res_8);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_8,x0_8,y0_8,nx_8,ny_8,nz_8,rcv_binned_8,num_rx_8,res_8);
		}
	}
	else if (blockIdx.y == 9)
	{
		if (is_vp_9)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_9,x0_9,y0_9,nx_9,ny_9,nz_9,rcv_binned_9,num_rx_9,res_9);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_9,x0_9,y0_9,nx_9,ny_9,nz_9,rcv_binned_9,num_rx_9,res_9);
		}
	}
	else if (blockIdx.y == 10)
	{
		if (is_vp_10)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_10,x0_10,y0_10,nx_10,ny_10,nz_10,rcv_binned_10,num_rx_10,res_10);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_10,x0_10,y0_10,nx_10,ny_10,nz_10,rcv_binned_10,num_rx_10,res_10);
		}
	}
	else if (blockIdx.y == 11)
	{
		if (is_vp_11)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_11,x0_11,y0_11,nx_11,ny_11,nz_11,rcv_binned_11,num_rx_11,res_11);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_11,x0_11,y0_11,nx_11,ny_11,nz_11,rcv_binned_11,num_rx_11,res_11);
		}
	}
	else if (blockIdx.y == 12)
	{
		if (is_vp_12)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_12,x0_12,y0_12,nx_12,ny_12,nz_12,rcv_binned_12,num_rx_12,res_12);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_12,x0_12,y0_12,nx_12,ny_12,nz_12,rcv_binned_12,num_rx_12,res_12);
		}
	}
	else if (blockIdx.y == 13)
	{
		if (is_vp_13)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_13,x0_13,y0_13,nx_13,ny_13,nz_13,rcv_binned_13,num_rx_13,res_13);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_13,x0_13,y0_13,nx_13,ny_13,nz_13,rcv_binned_13,num_rx_13,res_13);
		}
	}
	else if (blockIdx.y == 14)
	{
		if (is_vp_14)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_14,x0_14,y0_14,nx_14,ny_14,nz_14,rcv_binned_14,num_rx_14,res_14);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_14,x0_14,y0_14,nx_14,ny_14,nz_14,rcv_binned_14,num_rx_14,res_14);
		}
	}
	else if (blockIdx.y == 15)
	{
		if (is_vp_15)
		{
			cuExtract_Receiver_Particle_Velocity_Values(cmp_15,x0_15,y0_15,nx_15,ny_15,nz_15,rcv_binned_15,num_rx_15,res_15);
		}
		else
		{
			cuExtract_Receiver_Pressure_Values(cmp_15,x0_15,y0_15,nx_15,ny_15,nz_15,rcv_binned_15,num_rx_15,res_15);
		}
	}
}
