...
void Elastic_Modeling_Job::Write_Propagation_Earth_Model_To_Voxet(const char* base_filename, std::list<int> fields)
{
	...
	gcs->Convert_Local_Index_To_Global(prop_nu-1,0,0,g0,g1,g2);
	fprintf(fp,"AXIS_U %.6f %.6f %.6f\n",g0-o0,g1-o1,g2-o2);
	gcs->Convert_Local_Index_To_Global(0,prop_nv-1,0,g0,g1,g2);
	fprintf(fp,"AXIS_V %.6f %.6f %.6f\n",g0-o0,g1-o1,g2-o2);
	gcs->Convert_Local_Index_To_Global(0,0,prop_nw-1,g0,g1,g2);
